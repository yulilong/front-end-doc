...
本文整理、转载自掘金：https://juejin.cn/post/7576608733612425242
...
[SnapDOM](https://github.com/zumerlab/snapdom) 是一个现代化的 DOM 截图库，它的核心特点是：`DOM Element → **Canvas**/PNG/SVG`
...
更多详细内容请看:https://github.com/zumerlab/snapdom/blob/main/README_CN.md

## 3. jsPDF 介绍

[jsPDF](https://github.com/parallax/jsPDF) 是最流行的 JavaScript PDF 生成库，支持在浏览器端直接创建 PDF 文件。
...
[前端一行代码生成数千页PDF，dompdf.js新增分页功能](https://juejin.cn/post/7583912637470769203)
